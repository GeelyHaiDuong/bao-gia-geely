    ...
    return (React.createElement("div", { className: "min-h-screen font-sans pb-safe" },
        ...
        activeTab === 'preview' && (React.createElement("div", { className: "fixed bottom-0 left-0 right-0 p-4 bg-white border-t shadow-[0_-10px_15px_-3px_rgba(0,0,0,0.05)] z-20 flex justify-center pb-safe" },
            React.createElement("div", { className: "max-w-md w-full grid grid-cols-1" },
                React.createElement("button", { onClick: handleExportImage, disabled: isExporting, className: "w-full py-3 bg-blue-600 text-white rounded-xl font-bold text-sm shadow-md active:bg-blue-700 transition-colors" }, isExporting ? 'Đang tạo ảnh...' : 'Lưu Ảnh Báo Giá (Bản Nét)')))),
