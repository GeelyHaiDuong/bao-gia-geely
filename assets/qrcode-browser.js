...
var QRCode = __require(1);
var QRErrorCorrectLevel = __require(9);

function toDataURL(text, size) {
  size = Math.max(64, Number(size) || 256);
  ...
  for (var row = 0; row < count; row++) {
    for (var col = 0; col < count; col++) {
      if (qr.isDark(row, col)) {
        var x = Math.round((col + margin) * cell);
        var y = Math.round((row + margin) * cell);
        var x2 = Math.round((col + margin + 1) * cell);
        var y2 = Math.round((row + margin + 1) * cell);
...
var QR8bitByte = __require(2);
var QRUtil = __require(4);
var QRPolynomial = __require(5);
var QRRSBlock = __require(8);
var QRBitBuffer = __require(10);
...
var QRMode = __require(3);
var QRPolynomial = __require(5);
var QRMath = __require(6);
var QRMaskPattern = __require(7);
