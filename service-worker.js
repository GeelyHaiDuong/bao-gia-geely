const VERSION = 'geely-pwa-v2.5.0';
...
const CORE_ASSETS = [
  ...
  './assets/app.css','./assets/export-compat.css?v=250','./assets/custom.css?v=250','./assets/app.js?v=250',
  './assets/idb-store.js?v=250','./assets/firebase-sync.js?v=250',
  './assets/qrcode-browser.js','./assets/pwa.js?v=250',
