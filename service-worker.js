const VERSION = 'geely-pwa-v2.6.0';
...
const CORE_ASSETS = [
  ...
  './assets/app.css','./assets/export-compat.css?v=260','./assets/custom.css?v=260','./assets/app.js?v=260',
  './assets/idb-store.js?v=260','./assets/firebase-sync.js?v=260',
  './assets/qrcode-browser.js','./assets/pwa.js?v=260',
