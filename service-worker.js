const VERSION = 'geely-pwa-v2.0.0';
...
const CORE_ASSETS = [
  ...
  './assets/app.css','./assets/export-compat.css?v=200','./assets/app.js?v=200',
  './assets/idb-store.js?v=200','./assets/firebase-sync.js?v=200',
  './assets/qrcode-browser.js','./assets/pwa.js?v=200',
